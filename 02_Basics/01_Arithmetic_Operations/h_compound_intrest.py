...
principal_amount = float(input("Please Enter the principle Amount(Principal):"))
...
total_amount  = principal_amount * (1 + annual_interest / times_compounded) ** (times_compounded * duration_of_loan)
...
print("Final Amount of the loan:",round(total_amount,2))